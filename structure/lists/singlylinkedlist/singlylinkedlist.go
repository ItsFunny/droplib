...
import (
	...
	"github.com/hyperledger/fabric-droplib/structure/lists"
	"github.com/hyperledger/fabric-droplib/structure/utils"
)
...
func (list *List) Add(values ...interface{}) {
	list.AddReturnSize(values...)
}
func(list *List)AddReturnSize(values ...interface{}) int{
...
func (list *List) doRemove(index int) interface{} {
	if !list.withinRange(index) {
		return nil
	}
