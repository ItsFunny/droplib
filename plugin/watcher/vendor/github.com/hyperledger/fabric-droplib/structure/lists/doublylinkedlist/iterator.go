...
import "github.com/hyperledger/fabric-droplib/structure/containers"
...
func(list *List)ReverseIterator()Iterator{
	return Iterator{list: list,index: list.size,element: list.last}
}
