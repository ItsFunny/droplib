...
import (
	...
	"errors"
	"fmt"
	"github.com/hyperledger/fabric-droplib/protos/protobufs/crypto"
)
...
type OpDecoder func(proto crypto.ProofOpProto) (ProofOperator, error)
...
func (prt *ProofRuntime) Decode(pop crypto.ProofOpProto) (ProofOperator, error) {
...
func (prt *ProofRuntime) DecodeProof(proof *crypto.ProofOpsProto) (ProofOperators, error) {
...
func (prt *ProofRuntime) VerifyValue(proof *crypto.ProofOpsProto, root []byte, keypath string, value []byte) (err error) {
	return prt.Verify(proof, root, keypath, [][]byte{value})
}

// TODO In the long run we'll need a method of classifcation of ops,
// whether existence or absence or perhaps a third?
func (prt *ProofRuntime) VerifyAbsence(proof *crypto.ProofOpsProto, root []byte, keypath string) (err error) {
	return prt.Verify(proof, root, keypath, nil)
}

func (prt *ProofRuntime) Verify(proof *crypto.ProofOpsProto, root []byte, keypath string, args [][]byte) (err error) {
